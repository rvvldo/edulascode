...
export const storiesData: Record<number, Story> = {
    ...
    4: {
        ...
        scenes: [
            ...
            { id: 2, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Kita perlu sumber air alternatif. Pilihannya...", choices: [{ text: "Cari mata air di bukit.", isGood: true, scoreChange: 10, feedback: "Sumber air alami biasanya ada di dataran tinggi." }, { text: "Gali sumur lebih dalam lagi.", isGood: false, scoreChange: -5, feedback: "Bisa merusak akuifer tanah." }] },
            { id: 3, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Lesta", text: "Sungai desa berwarna keruh dan berbau." }] },
            { id: 4, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Warga membuang limbah rumah tangga ke sungai. Solusimu?", choices: [{ text: "Sosialisasi dampak dan buat tempat sampah.", isGood: true, scoreChange: 10, feedback: "Ubah perilaku adalah kunci." }, { text: "Marahi warga satu per satu.", isGood: false, scoreChange: -5, feedback: "Tidak efektif." }] },
            { id: 5, type: "NARRATIVE", background: "url('/background/kering.jpeg')')", dialogues: [{ character: "Sari", text: "Kita menemukan mata air, tapi tertutup semak belukar." }] },
            { id: 6, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Cara membersihkannya?", choices: [{ text: "Gotong royong bersihkan manual.", isGood: true, scoreChange: 10, feedback: "Kebersamaan!" }, { text: "Bakar semaknya agar cepat.", isGood: false, scoreChange: -10, feedback: "Bahaya kebakaran!" }] },
            { id: 7, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Lesta", text: "Hujan akhirnya turun! Tapi airnya terbuang percuma." }] },
            { id: 8, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Saran Sari untuk memanen air hujan?", choices: [{ text: "Buat biopori atau sumur resapan.", isGood: true, scoreChange: 10, feedback: "Menabung air untuk musim kemarau." }, { text: "Tampung di ember terbuka.", isGood: false, scoreChange: 5, feedback: "Rentan jentik nyamuk." }] },
            { id: 9, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Sari", text: "Ada pabrik di hulu yang diduga membuang limbah cair." }] },
            { id: 10, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Apa langkah yang tepat?", choices: [{ text: "Lapor ke Dinas Lingkungan Hidup.", isGood: true, scoreChange: 10, feedback: "Jalur hukum yang benar." }, { text: "Demo anarkis di depan pabrik.", isGood: false, scoreChange: -10, feedback: "Merugikan banyak pihak." }] },
            { id: 11, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Lesta", text: "Pipa saluran air desa bocor." }] },
            { id: 12, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Tindakan cepatmu?", choices: [{ text: "Tambal sementara dan panggil tukang.", isGood: true, scoreChange: 10, feedback: "Mencegah pemborosan." }, { text: "Tunggu pemerintah perbaiki.", isGood: false, scoreChange: -5, feedback: "Air keburu habis." }] },
            { id: 13, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Sari", text: "Anak-anak sekolah lupa menyalakan kran air." }] },
            { id: 14, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Cara edukasi anak-anak?", choices: [{ text: "Pasang poster lucu & ingatkan ramah.", isGood: true, scoreChange: 10, feedback: "Anak-anak suka visual." }, { text: "Hukum mereka.", isGood: false, scoreChange: -5, feedback: "Membuat trauma." }] },
            { id: 15, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Lesta", text: "Hutan di hulu desa mulai gundul." }] },
            { id: 16, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Hubungan hutan dan air sangat erat. Kita harus...", choices: [{ text: "Ajak warga menanam pohon (penghijauan).", isGood: true, scoreChange: 10, feedback: "Pohon menyimpan cadangan air tanah." }, { text: "Bangun vila di sana.", isGood: false, scoreChange: -10, feedback: "Merusak daerah resapan." }] },
            { id: 17, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Sari", text: "Air bersih mulai mengalir ke rumah-rumah!" }] },
            { id: 18, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Agar berkelanjutan, warga perlu...", choices: [{ text: "Membentuk kelompok pengelola air.", isGood: true, scoreChange: 10, feedback: "Manajemen berbasis komunitas." }, { text: "Berebut air.", isGood: false, scoreChange: -10, feedback: "Memicu konflik." }] },
            { id: 19, type: "NARRATIVE", background: "url('/background/kering.jpeg')", dialogues: [{ character: "Narator", text: "Air adalah sumber kehidupan." }] },
            { id: 20, type: "CHOICE", background: "url('/background/kering.jpeg')", question: "Janji kita pada air?", choices: [{ text: "Gunakan secukupnya, jangan boros.", isGood: true, scoreChange: 10, feedback: "Bijak!" }, { text: "Pakai sepuasnya selagi ada.", isGood: false, scoreChange: -5, feedback: "Egois." }] }
        ]
    },
    5: {
        id: 5,
